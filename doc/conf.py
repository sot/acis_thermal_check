# -*- coding: utf-8 -*-
#
# cmd_states documentation build configuration file, created by
...
htmlhelp_basename = 'acis_thermal_check_doc'
...
latex_documents = [
  ('index', 'acis_thermal_check.tex', u'ACIS Thermal Check Documentation',
