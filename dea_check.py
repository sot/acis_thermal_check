...
from acis_model_valid.utils import calc_off_nominal_rolls, plot_two, pointpair
...
class ACISModelValidation(object):
    def __init__(self, msid, short_msid, yellow, margin, validation_limits):
        self.msid = msid
    ...
    def make_week_predict(self, opt, tstart, tstop, bs_cmds, tlm, db):
        ...
        logger.info('Calculating %s thermal model' % self.short_msid.upper())
